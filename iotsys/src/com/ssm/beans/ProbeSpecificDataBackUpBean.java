...
public class ProbeSpecificDataBackUpBean implements Serializable {
	/**
	 * 数据ID
	 */
	private String id;
	...
	public ProbeSpecificDataBackUpBean(String id, String pkProbeId,
	...
	public ProbeSpecificDataBackUpBean() {
		super();
	}
