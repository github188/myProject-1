...
public class ProbeSpecificDataHourBean implements Serializable {
	/**
	 * 数据ID
	 */
	private int id;
	...
	public ProbeSpecificDataHourBean(int id, String pkProbeId,
	...
	public ProbeSpecificDataHourBean() {
		super();
	}
