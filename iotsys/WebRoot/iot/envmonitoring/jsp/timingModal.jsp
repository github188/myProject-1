	...
	<div class="modal-dialog">
		<div class="modal-content" style="height:auto">
			...
			<div class="modal-body">
				...
				<input type="text"  name="startTimes" disabled="disabled"  id="startTimes" style="width:220px;margin-left:25px" />
				</p>
				<p style="width:100%;height:36px;margin-top:12px">
				<span style="font-weight:bold;font-size:18px;margin-top:10px;height:30px">结束时间</span>
				<input type="text"  name="endTimes"  disabled="disabled"  id="endTimes" style="width:220px;margin-left:25px" />
				</p>
