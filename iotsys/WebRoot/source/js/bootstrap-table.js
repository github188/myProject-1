...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        formatLoadingMessage: function () {
            return '正在努力加载，请稍后...';   //Loading, please wait...
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('每页显示  %s 条', pageNumber); //%s records per page
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('', pageFrom, pageTo, totalRows);  //Showing %s to %s of %s rows
        },
        formatSearch: function () {
            return '搜索';
        },
        formatNoMatches: function () {
            return '未找到符合条件的记录';  //No matching records found
        },
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            '<div class="fixed-table-loading" style="top: 100px;  position: relative; text-align: center;">',
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        if (!this.options.showHeader || this.options.cardView) {
            ...
            this.$tableLoading.css('top', this.$header.outerHeight() + 45);
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            '<div class="pull-' + this.options.paginationHAlign + ' pagination" style="margin-top:4px;">',
        ...
        html.push(
            ...
            '<li style="margin-left: 24px;">到第<input type="text" id="goNum" style="width: 36px;line-height: 20px;margin-left: 5px;margin-right: 5px;height:21px;">页<input class="page-go btn btn-primary" type="button" value="确定" style="line-height: 15px;margin-bottom: 11px;margin-left: 10px"></li>',
            '</ul>',
            '',
            '</div>');
        ...
        $go = this.$pagination.find('.page-go');
        ...
        $go.off('click').on('click', $.proxy(this.onPageGo, this));
    };
    ...
    BootstrapTable.prototype.updatePagination = function (event) {
        ...
        $(".pagination").find(".page-number").eq(this.options.pageNumber-1).addClass('active');
    ...
    BootstrapTable.prototype.onPageGo = function (event) {
        var num = $("#goNum").val();
        if(num && num > 0 && num <= this.totalPages ){
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
            	//console.log(getItemField(item, field));
                var text = '',
